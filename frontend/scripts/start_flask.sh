...
export ADGSFE_DEBUG=TRUE; export ADGSFE_TEST=TRUE; nohup flask run --cert=/resources_path/boa_certificate.pem --key=/resources_path/boa_key.pem  --host=0.0.0.0 -p 5001 &> /log/flask_5001.log &
