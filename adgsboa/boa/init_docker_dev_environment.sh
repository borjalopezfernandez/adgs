#################################################################
#
# Init docker development environment script for BOA in the ADGS service
#
...
USAGE="Usage: `basename $0` -e path_to_eboa_src -v path_to_vboa_src -d path_to_dockerfile -o path_to_orc_packets -u host_user_to_map -t path_to_tailored [-b path_to_common_base] [-p port] [-l containers_label] [-a app] [-s path_to_boa_certificates] [-n] [-r]\n
Where:\n
